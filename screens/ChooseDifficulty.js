  ...
  render() {
    return (
      <View style={[containerStyle.centeredBoth, backgroundColorStyle.lightBlue]}>
        ...
        <LargeButton
          onPress={() => this.props.navigation.navigate('Categories', {difficulty: 'Easy'})}
          backgroundColor='#28a745'
          style={{marginBottom: 50}}
          title='EASY' />
        <LargeButton
          onPress={() => this.props.navigation.navigate('Categories', {difficulty: 'Medium'})}
          backgroundColor='orange'
          style={{marginBottom: 50}}
          title='MEDIUM' />
        <LargeButton
          onPress={() => this.props.navigation.navigate('Categories', {difficulty: 'Hard'})}
          backgroundColor='red'
          style={{marginBottom: 50}}
          title='HARD' />
      </View>
